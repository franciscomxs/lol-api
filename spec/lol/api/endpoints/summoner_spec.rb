...
describe LOL::Api::Endpoints::Summoner do
  ...
  describe '.call' do
    ...
    it 'is a alias for #data' do
      ...
      LOL::Api::Endpoints::Summoner.(region: region, summoner_ids: summoner_ids)
    end
  end

  describe '#data' do
    let(:response) { LOL::Api::Endpoints::Summoner.new(region: region, summoner_ids: summoner_ids).data }
